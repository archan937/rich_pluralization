...
== Version 1.0.7 (April 23, 2011)

* Using String inflections of Rich-Support
* Added String.pl!
* Made Rich-Pluralization a bit more legend: GemSuited up! ^^
* Removed plugin related code
* Using Bundler instead of Jeweler for gem publishing
* Made Rich-pluralization Ruby 1.9.2 compatible
* Using Rich::Support.after_initialize for configuring i18n
